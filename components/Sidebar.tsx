...
const Sidebar: React.FC<SidebarProps> = ({ activePage, setActivePage, isOpen, setIsOpen, user, appName }) => {
  ...
  return (
    <aside className={`w-64 flex-shrink-0 bg-white dark:bg-gray-800 border-l border-gray-200 dark:border-gray-700 flex flex-col
      ...
      <div className="p-4 border-t border-gray-200 dark:border-gray-700 flex-shrink-0">
        <p className="text-xs text-center text-gray-500">© 2024 {appName || 'CRM Pro'}</p>
      </div>
    </aside>
  );
};
