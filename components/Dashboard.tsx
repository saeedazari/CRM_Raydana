    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
      ...
      <div className="md:col-span-2 bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
          <div className="flex justify-between items-center mb-4">
            ...
            <button className="text-xs text-indigo-600 hover:underline">مشاهده همه</button>
          </div>
                ...
                <tbody>
                    {recentInvoices.map(inv => (
                        <tr key={inv.id} className="border-b dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                            <td className="px-3 py-3 font-mono text-xs">{inv.id}</td>
                            <td className="px-3 py-3">{inv.customerName}</td>
                            <td className="px-3 py-3 font-medium">{inv.totalAmount.toLocaleString('fa-IR')}</td>
